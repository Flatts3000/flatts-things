 ...
 * 50, so they landed on top of hotbar slots one to five, drew their silhouettes there, and were live
 * to clicks - while {@code ToolSlotStrip}, which correctly refuses to paint on anything that is not
 * an {@code InventoryScreen}, left no panel behind them.
 *
