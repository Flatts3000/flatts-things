...
**Status:** current, researched and written 2026-09-07. Sourced from the primary HCI literature
rather than from summaries; every rule below is attributed, and the claims that could NOT be
sourced are listed at the bottom rather than quietly dropped. No feature in this mod has been
audited against it yet.
...
after. This document exists because this mod keeps arriving at feedforward problems without the
...
## Applying it to this mod

Observations rather than a work plan. Each names what the surface currently does.
...
**Placement preview (issue 60) is the case study**, and the reason this document exists. The
